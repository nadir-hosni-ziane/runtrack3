...
<body>
    ...
    <main>
        ...
        <div class="container-fluid mt-2">
            <div class="row">
                ...
                <div class="col-8">
                    ...
                    <p class="lead">le monde est la matière, l'espace et les phénomènes qui nous sont aaccessibles par les sens, l'expérience ou la raison.<br>Le sens le plus courant désigne notre planète, la Terre, avec ses habitants, et son environnement plus ou moins naturel.</p>
                    <hr class="my-4">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 d-flex justify-content-center">
                    <div class="col-9">
                        <label class="col mr-15 text-end"><h5>Installation de Al-9000</h5></label>
                        <div class="progress">
        ...
        <div class="row">
            <div class="col-6">
            <div class="txt">Recevez votre copie gratuite d'internet 2!</div>
        ...
        <div class="form-group">
            ...
            <input type="mail" class="form-control" id="formGroupExampleInput" placeholder="Example input">
